...
$imageUrl = $_SESSION['agent_image'] ?? false;
$agent = $_SESSION['agent'] ?? false;
?>
        ...
        <header id="sticky-header" class="relative bg-[#F5F9F8] lg:py-[30px] z-10 secondary-sticky secondary-sticky">
                        ...
                        <div class="flex flex-wrap items-center justify-between">
                            ...
                            <nav class="flex flex-wrap items-center">
                                <ul class="hidden lg:flex flex-wrap items-center font-recoleta text-[16px] xl:text-[18px] leading-none text-black">
                                    ...
                                    <?php if(!$logged_in) { 
                                            echo "<li class='mr-7 xl:mr-[40px] relative group py-[20px]'>
                                                <a href='/login' class='transition-all hover:text-secondary'>Post your lodge</a>
                                                </li>";
                                    }
                                    ?>
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="/agency" class="transition-all hover:text-secondary">Agency</a>
            ...
            ">
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="/agency" class="font-recoleta leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-t-[12px]">Find an agency</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="/new-agency" class="font-recoleta leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px]">Register your agency</a>
                                            </li>
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="/contact" class="transition-all hover:text-secondary">Contact</a>
                                ...
                                <ul class="flex flex-wrap items-center">
                                    <li class="sm:mr-5 xl:mr-[20px] relative group"><a href="#">
                                            <img src="<?php echo ($imageUrl) ? $imageUrl : "assets/images/user/avater.png" ?>" loading="lazy" width="62" height="62" alt="avater">
                                        </a>
                ...
                ">
                                            <?php 
                                                if(!$logged_in) {
                                                    ...
                                                    echo '<a href="/login" class="font-recoleta leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-t-[12px]">Login</a>';
                                                    echo '</li>';
                                                }
                                                ?>
                                            ...
                                            <?php 
                                                if(!$logged_in) {
                                                    echo "<li class='border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all'>
                                                        <a href='/new-agent' class='font-recoleta leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-b-[12px]'>Become an agent</a>
                                                        </li>";
                                                }
                                            ?>
                                        </ul>
            ...
            <div class="py-12 pr-5 h-[100vh] overflow-y-auto">
                ...
                <nav class="offcanvas-menu">
                    <ul>
                        ...
                        <li class="relative block border-b-primary border-b">
                            <a href="#" class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5"><?php echo ($logged_in and $agent) ? 'My Apartments' : 'Apartments' ?></a>
                         
                        </li>

                        <?php if(!$logged_in) { 
                                echo "<li class='relative block border-b-primary border-b'><a href='/login' class='relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5'>Post a lodge</a>";
                            }
                        ?>
                        ...
                        <li class="relative block border-b-primary border-b"><a href="#" class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">agency</a>
                            ...
                            <ul class="offcanvas-submenu static top-auto hidden w-full visible opacity-100 capitalize">
                                <li>
                                    <a href="/agency" class="text-sm pt-3 px-10 pb-1 text-black font-light block transition-all hover:text-secondary">Find an agency</a>
                                </li>
                                <li>
                                    <a href="/new-agency" class="text-sm pt-3 px-10 pb-1 text-black font-light block transition-all hover:text-secondary">Register your agency</a>
                                </li>
                ...
                <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
                        ...
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            ...
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="/agent">Our Agents</a></li>
