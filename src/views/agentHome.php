                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="assets/user/assets/images/faces/5.jpg">
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="assets/user/assets/images/faces/2.jpg">
                                                                </div>
                            ...
                            <div class="card-content pb-4">
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="assets/user/assets/images/faces/4.jpg">
                                    </div>
                                    <div class="name ms-4">
                                ...
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="assets/user/assets/images/faces/1.jpg">
                                    </div>
                                    <div class="name ms-4">
