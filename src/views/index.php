                            ...
                            <div class="col-span-12 lg:col-span-5 xl:col-span-6">
                                <div class="slider-content">
                                    <div class="relative mb-5 sub_title">
                                        <img class="animate-animateSpin" src="assets/images/hero/cogs.png" width="62"
                                            height="62" alt="icon">
                                        <span
                                            class="bg-[#FFF6F0] text-base text-secondary block absolute left-[28px] top-1/2 -translate-y-1/2"
                                            style="background-color:  rgb(236 250 247/var(--tw-bg-opacity))">A new way
                                            to find Properties</span>
                                    </div>
                                    <h1
                                        class="font-recoleta text-primary text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl title">
                                    ...
                                    <span class="block font-recoleta hero_info"><span
                                            class="text-[20px] sm:text-[22px] text-secondary">Have a question?</span> <a
                                            href="tel:9985254784"
                                            class="text-[22px] sm:text-[32px] text-primary hover:underline">+9985 254
                                            784</a></span>
                                </div>
                            </div>
                            <div class="col-span-12 lg:col-span-7 xl:col-span-6">
                                <div
                                    class="relative mt-10 md:mt-0 lg:absolute xl:right-[30px] 2xl:right-[130px] lg:top-1/2 lg:-translate-y-1/2 3xl:max-w-[830px] 2xl:max-w-[700px] xl:max-w-[630px] lg:max-w-[550px]">
                                    <img class="hero_image" src="assets/images/hero/hero.png" width="849" height="739"
                                        alt="hero image">


                                    <svg class="mysvg absolute top-[-20px] md:top-[0px] lg:top-[20px] xl:top-[38px] 2xl:top-[68px] 3xl:top-[133px] 3xl:left-[-50px] 2xl:left-[-40px] xl:left-[-40px] lg:left-[-40px] left-0"
                                    ...
                                    <div class="scene" data-relative-input="true">
                                        <img data-depth="0.2"
                                            class="hero-star absolute bottom-[-55px] sm:bottom-0 lg:bottom-[150px] xl:bottom-[185px] 3xl:bottom-[250px] 3xl:left-[60px] 2xl:left-[50px] lg:left-[30px]"
                                            src="assets/images/hero/shape2.svg" width="98" height="74" alt="icon">
                                    </div>

                                    <svg class="orange-shape absolute bottom-[0%] lg:bottom-[120px] xl:bottom-[140px] 2xl:bottom-[150px] 3xl:bottom-[190px] 3xl:right-[135px] 2xl:right-[120px] xl:right-[110px] lg:right-[80px] right-[30px]"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 59 56"
                                        width="59" height="56">
    ...
    <div class="container">
        <div class="grid grid-cols-12">
            <div class="col-span-12 relative">
                ...
                <button
                    class="tab-toggle-btn px-[10px] py-[15px] absolute bottom-[-56px] left-[-45px] border-l border-t border-b border-solid border-[#0000] bg-white text-primary border-opacity-25 rounded-tl-[10px] rounded-bl-[10px]"
                    aria-label="svg icon">
            ...
            <div class="col-span-12 selectricc-border-none">
                <div id="buy"
                    class="tab-content bg-white border border-solid border-[#0000] border-opacity-25 rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[40px] active">
                    
                    <form action="/search-lodge" method="GET" id="search_form">
                        <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <label for="location"
                                        class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Description</label>
                                    <input id="description" name="description" type="text" placeholder="Describe this lodge"
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    <input id="location" name="location" type="text" placeholder="Choose location"
                                        class="text-tiny placeholder:text-body leading-none font-light pr-3 focus:outline-none w-full">
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <label for="category"
                                        class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Category</label>
                            ...
                            <div
                                ...
                                <button type="submit" id="search_submit"
                                    class="search-btn absolute right-0 lg:right-[-60px] xl:right-[-70px]">
                        ...
                        <div class="advanced-searrch-hidden flex flex-wrap items-center mt-[45px] -mb-[45px]">
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <label for="basic"
                                        class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Basic</label>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <label for="entertain"
                                        class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Entertainment</label>
                                    <select name="entertain"
                                        class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <label for="garage"
                                        class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Study
                                        Tools</label>
...
<section class="popular-properties py-[80px] lg:py-[120px]">
    <div class="container">
                ...
                <div class="flex flex-col sm:flex-row items-start justify-between mb-[50px]">
                    ...
                    <div>
                        <a href="properties-v1.html"
                            class="flex flex-wrap items-center text-secondary text-tiny">Explore all
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
            ...
            <div
                class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                <div class="relative">
                    <a href="/properties-details" class="block">
                        <img src="assets/images/properties/properties1.jpg" class="w-full h-full" loading="lazy"
                            width="370" height="266" alt="Orchid Casel de Paradise.">
                    </a>
                    <div class="flex flex-wrap flex-col absolute top-5 right-5">
                        <button
                            class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img
                                class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10"
                                alt="camera icon">07</button>
                        <button
                            class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img
                                class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10"
                                alt="camera icon">08</button>
                    </div>
                    <span
                        class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-secondary leading-none text-[14px] font-normal capitalize">for
                        Sale</span>
                </div>

                <div class="py-[20px] px-[20px]">
                    <h3><a href="/properties-details"
                            class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Orchid Casel de
                            Paradise.</a></h3>
                    <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">18B Central
                            Street, San Francisco</a></h4>
                    <span class="font-light text-sm">Added: 25 November, 2021</span>
                    <div
                        class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                        <span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span>
                    </div>
            ...
            <div
                ...
                <div class="relative">
                    <a href="/properties-details" class="block">
                        <img src="assets/images/properties/properties2.jpg" class="w-full h-full" loading="lazy"
                ...
                <div class="py-[20px] px-[20px]">
                    <h3><a href="/properties-details"
                            class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Ruposibangla de
                            parlosia.</a></h3>
                    <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">18B Central
                            Street, San Francisco</a></h4>
                    <span class="font-light text-sm">Added: 25 November, 2021</span>
            ...
            <div
                ...
                <div class="relative">
                    <a href="/properties-details" class="block">
                        <img src="assets/images/properties/properties3.jpg" class="w-full h-full" loading="lazy"
                ...
                <div class="py-[20px] px-[20px]">
                    <h3><a href="/properties-details"
                            class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Sinomen Studio
                            Palace.</a></h3>
                    <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">194 Mercer
                            Street, 627 Broadway, New York</a></h4>
                    <span class="font-light text-sm">Added: 25 November, 2021</span>
                    <div
                        class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                        <span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span>
    ...
    <div class="container">
        <div class="grid grid-cols-12">
            <div class="col-span-12 lg:col-span-7">
                <div class="scene" data-relative-input="true">
                    <img data-depth="0.1" src="assets/images/about/about.png"
                        class="2xl:ml-[-130px] mx-auto lg:max-w-[500px] xl:max-w-[729px]" loading="lazy" width="729"
            ...
            <div class="col-span-12 flex flex-wrap flex-col md:flex-row items-start justify-between mb-[50px]">
                ...
                <ul class="all-properties flex flex-wrap lg:pt-[10px]">
                    ...
                    <li data-tab="co-living2" class="md:mr-[0px] mb-4 lg:mb-0 leading-none"><button
                            class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out">Co-living</button>
                    </li>
                </ul>
            </div>
            <div class="col-span-12">
                <div id="all-properties" class="properties-tab-content active">
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                        ...
                        <div
                            ...
                            <div class="relative">
                                <a href="/properties-details" class="block">
                                    <img src="assets/images/properties/properties4.jpg" class="w-full h-full"
                                        loading="lazy" width="370" height="266" alt="Elite Garden Resedence.">
                                </a>
                                <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                    <button
                                        class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img
                                            class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13"
                                            height="10" alt="camera icon">07</button>
                                    <button
                                        class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img
                                            class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14"
                            ...
                            <div class="py-[20px] px-[20px]">
                                <h3><a href="/properties-details"
                                        class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Elite
                                        Garden Resedence.</a></h3>
                                <h4><a href="/properties-details"
                                        class="font-light text-tiny text-secondary underline">253 Montril Street, South
                                        Town, Miami</a></h4>
                                <span class="font-light text-sm">Added: 25 November, 2021</span>
                                <div
                                    class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                                    <span class="font-recoleta text-base text-primary px-[15px] bg-white">Price:
                                        $255300</span></div>
                                <p class="font-light">1230 Sq.fit - 4 Bed - 3 Bath - 2 Garage</p>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="relative">
                                <a href="/properties-details" class="block">
                                    <img src="assets/images/properties/properties5.jpg" class="w-full h-full"
                                        loading="lazy" width="370" height="266" alt="De Parasiya Appartment.">
                                </a>
                                <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                    <button
                                        class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img
                            ...
                            <div class="py-[20px] px-[20px]">
                                <h3><a href="/properties-details"
                                        class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">De
                                        Parasiya Appartment.</a></h3>
                                <h4><a href="/properties-details"
                                        class="font-light text-tiny text-secondary underline">18B Central Street, San
                                        Francisco</a></h4>
                                <span class="font-light text-sm">Added: 25 November, 2021</span>
                                <div
                                    class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                        ...
                        <div
                            ...
                            <div class="relative">
                                <a href="/properties-details" class="block">
                                    <img src="assets/images/properties/properties6.jpg" class="w-full h-full"
                                        loading="lazy" width="370" height="266" alt="Duplex de Villa.">
                                </a>
                                <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                    <button
                                        class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img
                            ...
                            <div class="py-[20px] px-[20px]">
                                <h3><a href="/properties-details"
                                        class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Duplex
                                        de Villa.</a></h3>
                                <h4><a href="/properties-details"
                                        class="font-light text-tiny text-secondary underline">194 Mercer Street, 627
                                        Broadway, New York</a></h4>
                                <span class="font-light text-sm">Added: 25 November, 2021</span>
                                <div
                                    class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                                    <span class="font-recoleta text-base text-primary px-[15px] bg-white">Price:
                        ...
                        <div
                            ...
                            <div class="relative">
                                <a href="/properties-details" class="block">
                                    <img src="assets/images/properties/properties7.jpg" class="w-full h-full"
                            ...
                            <div class="py-[20px] px-[20px]">
                                <h3><a href="/properties-details"
                                        class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Orchid
                                        Casel de Paradise.</a></h3>
                                <h4><a href="/properties-details"
                                        class="font-light text-tiny text-secondary underline">2846 West Side Avenue, New
                                        Jersey</a></h4>
                                <span class="font-light text-sm">Added: 25 November, 2021</span>
                                <div
                                    class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                        ...
                        <div
                            ...
                            <div class="py-[20px] px-[20px]">
                                <h3><a href="/properties-details"
                                        class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Ruposibangla
                                        de parlosia.</a></h3>
                                <h4><a href="/properties-details"
                                        class="font-light text-tiny text-secondary underline">2381 Richards Avenue,
                                        Stockton, California</a></h4>
                                <span class="font-light text-sm">Added: 25 November, 2021</span>
                                <div
                                    class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                                    <span class="font-recoleta text-base text-primary px-[15px] bg-white">Price:
                        ...
                        <div
                            ...
                            <div class="py-[20px] px-[20px]">
                                <h3><a href="/properties-details"
                                        class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Sinomen
                                        Studio Palace.</a></h3>
                                <h4><a href="/properties-details"
                                        class="font-light text-tiny text-secondary underline">4658 Oakwood Avenue, New
                                        York</a></h4>
                                <span class="font-light text-sm">Added: 25 November, 2021</span>
                                <div
                                    class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative">
                ...
                <div id="ForRent" class="properties-tab-content">
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                        ...
                        <div
                            ...
                            <div class="relative">
                                <a href="/properties-details" class="block">
                                    <img src="assets/images/properties/properties8.jpg" class="w-full h-full"
                                        loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                                </a>
                                <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                    <button
        ...
        <div class="grid grid-cols-12 gap-[30px] items-center">
            <div class="col-span-12 lg:col-span-6 relative">
                <div class="mb-5 lg:mb-0 max-w-[450px]">
                    ...
                    <img class="absolute bottom-[-18px] right-[5px]" src="assets/images/video/star.png" loading="lazy"
                        width="65" height="73" alt="image">
            ...
            <div class="col-span-12 lg:col-span-6 text-center">
                <div class="relative rounded-[24px] pt-[45px] pr-[45px] z-[1] inline-block">
                    <div class="absolute top-0 right-0 bg-primary w-[90%] h-[90%] rounded-[24px] z-[-2]">
                        ...
                        <img src="assets/images/video/shape.png" class="absolute top-[18px] left-[-17px] z-[-1]"
                            loading="lazy" width="68" height="56" alt="shape image">
                        <img src="assets/images/video/shape.png" class="absolute bottom-[15px] right-[15px] z-[-1]"
                            loading="lazy" width="68" height="56" alt="shape image">
                    </div>
                    <div class="relative">
                        <div class="scene" data-relative-input="true">
                    ...
                    <div class="swiper  -mx-[30px] -my-[60px] px-[30px] py-[60px]">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide text-center">
                                <div class="relative group">
                                    <a href="agency-details.html" class="block">
                                        <img src="assets/images/cities/cities1.png"
                                            class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy"
                                            width="270" height="290" alt="New York">
                                        <div
                                            class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                            <span
                                                class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">New
                                                York</span>
                                            <p
                            ...
                            <div class="swiper-slide text-center">
                                <div class="relative group">
                                    <a href="agency-details.html" class="block">
                                        <img src="assets/images/cities/cities2.png"
                                            class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy"
                                            width="270" height="290" alt="Sun Francisco">
                                        <div
                                            class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                            <span
                                                class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Sun
                                                Francisco</span>
                                            <p
                                                class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">
                                                18 Properties</p>
                            ...
                            <div class="swiper-slide text-center">
                                <div class="relative group">
                                    <a href="agency-details.html" class="block">
                                        <img src="assets/images/cities/cities3.png"
                                            class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy"
                                            width="270" height="290" alt="Washington D.C.">
                                        <div
                                            class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                            <span
                                                class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Washington
                                                D.C.</span>
                                            <p
                                                class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">
                                                27 Properties</p>
                            ...
                            <div class="swiper-slide text-center">
                                <div class="relative group">
                                    <a href="agency-details.html" class="block">
                                        <img src="assets/images/cities/cities4.png"
                                            class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy"
                                            width="270" height="290" alt="New York">
                                        <div
                                            class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                            ...
                            <div class="swiper-slide text-center">
                                <div class="relative group">
                                    <a href="agency-details.html" class="block">
                                        <img src="assets/images/cities/cities2.png"
                                            class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy"
                                            width="270" height="290" alt="Francisco">
                                        <div
                                            class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                            <span
                                                class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Francisco</span>
                                            <p
                                                class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">
                                                18 Properties Sun</p>
                                        </div>
...
<section class="testimonial-section pt-[50px] bg-no-repeat bg-white relative z-10"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="relative text-right">
                                ...
                                <div
                                    ...
                                    <img src="assets/images/testimonial/person1.png"
                                        class="w-auto h-auto block mx-auto relative z-[2]" loading="lazy" width="300"
                                        height="380" alt="Oliver Stephen">
                                ...
                                <div
                                    ...
                                    <span class="block absolute right-[20px] top-[30px]">
                                        <svg class="ml-auto mb-[4px]" width="27" height="20" viewBox="0 0 27 20"
                                    ...
                                    <ul>
                                        <li class="flex flex-wrap items-center justify-between mt-4">
                                            <span
                                                class="font-recoleta text-[18px] leading-none capitalize text-secondary">Oliver
                                                Stephen</span>
                        ...
                        <div class="swiper-slide">
                            <div class="relative text-right">
                                ...
                                <div
                                    class="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                                    <img src="assets/images/testimonial/person3.png"
                                        class="w-auto h-auto block mx-auto relative z-[2]" loading="lazy" width="300"
                                        height="380" alt="Sun Francisco">
                                    <img class="absolute right-[20px] bottom-0 z-[1]"
                                        src="assets/images/testimonial/shape.png" width="130" height="132"
                                        loading="lazy" alt="shape">
                                </div>
                                ...
                                <div
                                    ...
                                    <ul>
                                        <li class="flex flex-wrap items-center justify-between mt-4">
                                            <span
                                                class="font-recoleta text-[18px] leading-none capitalize text-secondary">Sun
                                                Francisco</span>
                                            <span class="flex flex-wrap">
                                                <span class="ml-[4px]">
                                                    <svg width="10" height="11" viewBox="0 0 10 11" fill="none"
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-[30px] mb-[-30px]">
                ...
                <div class="relative rounded-[6px_6px_0px_0px]">
                    <a href="agent-details.html"
                        ...
                        <img src="assets/images/team/person1.png" class="w-auto h-auto block mx-auto" loading="lazy"
                            width="215" height="310" alt="Albert S. Smith">
                    </a>
                </div>
            ...
            <div class="text-center group mb-[30px]">
                <div class="relative rounded-[6px_6px_0px_0px]">
                    <a href="agent-details.html"
                        class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                        <img src="assets/images/team/person4.png" class="w-auto h-auto block mx-auto" loading="lazy"
