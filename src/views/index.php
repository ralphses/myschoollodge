        ...
        <!-- Hero section start -->
        <section class="bg-[#FFF6F0] relative" style="background-color:  rgb(236 250 247/var(--tw-bg-opacity))">
                                    ...
                                    <div class="col-span-12 lg:col-span-5 xl:col-span-6">
                                        <div class="slider-content">
                                            <div class="relative mb-5 sub_title">
                                                <img class="animate-animateSpin" src="assets/images/hero/cogs.png" width="62" height="62" alt="icon">
                                                <span class="bg-[#FFF6F0] text-base text-secondary block absolute left-[28px] top-1/2 -translate-y-1/2" style="background-color:  rgb(236 250 247/var(--tw-bg-opacity))">A new way
                      to find Properties</span>
                                            </div>
                                            ...
                                            <div class="inline-block mb-7 hero_btn">
                                                <a href="/contact" class="before:rounded-md before:block before:absolute before:left-auto before:right-0 before:inset-y-0 before:-z-[1] before:bg-secondary before:w-0 hover:before:w-full hover:before:left-0 hover:before:right-auto before:transition-all leading-none px-[20px] py-[15px] capitalize font-medium text-white text-[14px] xl:text-[16px] relative after:block after:absolute after:inset-0 after:-z-[2] after:bg-primary after:rounded-md after:transition-all block">Contact
                                                    us</a>
                                            </div>
                                            <span class="block font-recoleta hero_info"><span
                      class="text-[20px] sm:text-[22px] text-secondary">Have a question?</span> <a href="tel:9985254784" class="text-[22px] sm:text-[32px] text-primary hover:underline">+9985 254 784</a></span>
                                        </div>
                                    </div>
                                    <div class="col-span-12 lg:col-span-7 xl:col-span-6">
                                        <div class="relative mt-10 md:mt-0 lg:absolute xl:right-[30px] 2xl:right-[130px] lg:top-1/2 lg:-translate-y-1/2 3xl:max-w-[830px] 2xl:max-w-[700px] xl:max-w-[630px] lg:max-w-[550px]">
                                            <img class="hero_image" src="assets/images/hero/hero.png" width="849" height="739" alt="hero image">
                                            ...
                                            <div class="scene" data-relative-input="true">
                                                <img data-depth="0.2" class="hero-star absolute bottom-[-55px] sm:bottom-0 lg:bottom-[150px] xl:bottom-[185px] 3xl:bottom-[250px] 3xl:left-[60px] 2xl:left-[50px] lg:left-[30px]" src="assets/images/hero/shape2.svg" width="98" height="74" alt="icon">
                                            </div>
            ...
            <img class="absolute left-0 bottom-0" src="assets/images/hero/star.png" width="112" height="138" alt="icon">
        </section>
            ...
            <div class="container">
                <div class="grid grid-cols-12">
                    <div class="col-span-12 relative">
                        ...
                        <button class="tab-toggle-btn px-[10px] py-[15px] absolute bottom-[-56px] left-[-45px] border-l border-t border-b border-solid border-[#0000] bg-white text-primary border-opacity-25 rounded-tl-[10px] rounded-bl-[10px]" aria-label="svg icon">
                    ...
                    <div class="col-span-12 selectricc-border-none">
                        <div id="buy" class="tab-content bg-white border border-solid border-[#0000] border-opacity-25 rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[40px] active">
                            <form action="/search-lodge" method="GET">
                                <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <input id="location" name="location" type="text" placeholder="Choose location" class="text-tiny placeholder:text-body leading-none font-light pr-3 focus:outline-none w-full">
                                        </div>
                                    </div>
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                        ...
                                        <div class="flex-1">
                                            <label for="category" class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Category</label>
                                            <select name="category" id="category" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px]">
                                        ...
                                        <div class="flex-1">
                                            <label for="sub-category" class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Type</label>
                                            <select name="sub-category" id="sub-category" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                                <option selected value="0">Single Rooms</option>
                                                <option value="1">Flats</option>
                                                <option value="2">Bunks</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px] relative">
                                        ...
                                        <div class="flex-1">
                                            <label for="price_range" class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Price Range</label>
                                            <select name="price_range" id="price_range" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                                <option selected value="maximum N100,000">maximum N100,000</option>
                                                <option value="N100,000 - N150,000">N100,000 - N150,000</option>
                                                <option value="N150,000 - N200,000">N150,000 - N200,000</option>
                                                <option value="N200,000 - N300,000">N200,000 - N300,000</option>
                                                <option value="N300,000 - N500,000">N300,000 - N500,000</option>
                                                <option value="N500,000 - N1,000,000">N500,000 - N1,000,000</option>
                                            </select>
                                        </div>
                                        <button type="submit" class="search-btn absolute right-0 lg:right-[-60px] xl:right-[-70px]">
                                ...
                                <div class="advanced-searrch-hidden flex flex-wrap items-center mt-[45px] -mb-[45px]">
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px] search-list">
                                        ...
                                        <div class="flex-1">
                                            <label for="basic" class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Basic</label>
                                            <select name="basic" id="basic" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px] search-list">
                                        ...
                                        <div class="flex-1">
                                            <label for="entertain" class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Entertainment</label>
                                            <select name="entertain" class="nice-select appearance-none bg-transparent text-tiny font-light cursor-pointer">
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px] search-list">
                                        ...
                                        <div class="flex-1">
                                            <label for="garage" class="font-recoleta block capitalize text-primary text-[18px] xl:text-[25px] leading-none mb-1">Study Tools</label>
                                    ...
                                    <div class="advanced-searrch-list flex items-center lg:border-r lg:border-[#D6D4D4] lg:mr-[40px] xl:mr-[50px] last:mr-0 last:border-r-0 mb-[45px] search-list">
                                        <button type="submit" class="search-properties-btn">
                                            Search Properties
                                        </button>
                                    </div>
                        ...
                        <!-- <div id="sell" class="tab-content bg-white border border-solid border-[#0000] border-opacity-25 rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[40px]">
                            <form action="#">
                                <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
                        ...
                        <div id="rent" class="tab-content bg-white border border-solid border-[#0000] border-opacity-25 rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[40px]">
                            <form action="#">
                                <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
                        ...
                        <div id="co-living" class="tab-content bg-white border border-solid border-[#0000] border-opacity-25 rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[40px]">
                            <form action="#">
                                <div class="advanced-searrch flex flex-wrap items-center -mb-[45px]">
            ...
            <div class="container">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                    ...
                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                        <div class="relative">
                            <a href="/properties-details" class="block">
                                <img src="assets/images/properties/properties1.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                            </a>
                        ...
                        <div class="py-[20px] px-[20px]">
                            <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Orchid Casel de Paradise.</a></h3>
                            <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">18B Central Street, San Francisco</a></h4>
                    ...
                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                        <div class="relative">
                            <a href="/properties-details" class="block">
                                <img src="assets/images/properties/properties2.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Ruposibangla de parlosia.">
                            </a>
                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                        ...
                        <div class="py-[20px] px-[20px]">
                            <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Ruposibangla de parlosia.</a></h3>
                            <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">18B Central Street, San Francisco</a></h4>
                            <span class="font-light text-sm">Added: 25 November, 2021</span>
                            <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                    ...
                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                        <div class="relative">
                            <a href="/properties-details" class="block">
                                <img src="assets/images/properties/properties3.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Sinomen Studio Palace.">
                            </a>
                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                        ...
                        <div class="py-[20px] px-[20px]">
                            <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Sinomen Studio Palace.</a></h3>
                            <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">194 Mercer Street, 627 Broadway, New York</a></h4>
                            <span class="font-light text-sm">Added: 25 November, 2021</span>
                            <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                            <p class="font-light">1230 Sq.fit - 4 Bed - 3 Bath - 2 Garage</p>
                        </div>
                        ...
                        <div id="all-properties" class="properties-tab-content active">
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    ...
                                    <div class="py-[20px] px-[20px]">
                                        <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Elite Garden Resedence.</a></h3>
                                        <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">253 Montril Street, South Town, Miami</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                                        <p class="font-light">1230 Sq.fit - 4 Bed - 3 Bath - 2 Garage</p>
                                    </div>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties5.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="De Parasiya Appartment.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                    ...
                                    <div class="py-[20px] px-[20px]">
                                        <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">De Parasiya Appartment.</a></h3>
                                        <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">18B Central Street, San Francisco</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                                        <p class="font-light">1800 Sq.fit - 5 Bed - 3 Bath - 2 Garage</p>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties6.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Duplex de Villa.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                    ...
                                    <div class="py-[20px] px-[20px]">
                                        <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Duplex de Villa.</a></h3>
                                        <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">194 Mercer Street, 627 Broadway, New York</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                                        <p class="font-light">1800 Sq.fit - 5 Bed - 3 Bath - 2 Garage</p>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties7.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                    ...
                                    <div class="py-[20px] px-[20px]">
                                        <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Orchid Casel de Paradise.</a></h3>
                                        <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">2846 West Side Avenue, New Jersey</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                                        <p class="font-light">1230 Sq.fit - 4 Bed - 3 Bath - 2 Garage</p>
                                    </div>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties3.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Ruposibangla de parlosia.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                    ...
                                    <div class="py-[20px] px-[20px]">
                                        <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Ruposibangla de parlosia.</a></h3>
                                        <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">2381 Richards Avenue, Stockton, California</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                                        <p class="font-light">1230 Sq.fit - 4 Bed - 3 Bath - 2 Garage</p>
                                    </div>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    ...
                                    <div class="py-[20px] px-[20px]">
                                        <h3><a href="/properties-details" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary">Sinomen Studio Palace.</a></h3>
                                        <h4><a href="/properties-details" class="font-light text-tiny text-secondary underline">4658 Oakwood Avenue, New York</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <div class="before:block before:absolute before:top-1/2 before:-translate-y-1/2 before:h-[1px] before:w-full before:z-[-1] before:bg-[#E0E0E0] relative"><span class="font-recoleta text-base text-primary px-[15px] bg-white">Price: $255300</span></div>
                                        <p class="font-light">1230 Sq.fit - 4 Bed - 3 Bath - 2 Garage</p>
                                    </div>
                        ...
                        <div id="ForBuy" class="properties-tab-content">
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties3.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="De Parasiya Appartment.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties4.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties5.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Ruposibangla de parlosia.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                        ...
                        <div id="ForSale" class="properties-tab-content">
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties6.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="De Parasiya Appartment.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties5.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Duplex de Villa.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties1.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Sinomen Studio Palace.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                        ...
                        <div id="ForRent" class="properties-tab-content">
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties8.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                        ...
                        <div id="co-living2" class="properties-tab-content">
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="/properties-details" class="block">
                                            <img src="assets/images/properties/properties2.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="Sinomen Studio Palace.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                ...
                <div class="grid grid-cols-12 gap-[30px] items-center">
                    <div class="col-span-12 lg:col-span-6 relative">
                        <div class="mb-5 lg:mb-0 max-w-[450px]">
                            ...
                            <img class="absolute bottom-[-18px] right-[5px]" src="assets/images/video/star.png" loading="lazy" width="65" height="73" alt="image">
                    ...
                    <div class="col-span-12 lg:col-span-6 text-center">
                        <div class="relative rounded-[24px] pt-[45px] pr-[45px] z-[1] inline-block">
                            <div class="absolute top-0 right-0 bg-primary w-[90%] h-[90%] rounded-[24px] z-[-2]">
                                ...
                                <img src="assets/images/video/shape.png" class="absolute top-[18px] left-[-17px] z-[-1]" loading="lazy" width="68" height="56" alt="shape image">
                                <img src="assets/images/video/shape.png" class="absolute bottom-[15px] right-[15px] z-[-1]" loading="lazy" width="68" height="56" alt="shape image">
                            </div>
                            <div class="relative">
                                <div class="scene" data-relative-input="true">
                                    <img data-depth="0.1" src="assets/images/video/video.png" class="rounded-[24px]" loading="lazy" width="507" height="349" alt="video image">
                                </div>
                            ...
                            <div class="swiper  -mx-[30px] -my-[60px] px-[30px] py-[60px]">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="assets/images/cities/cities1.png" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="New York">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">New York</span>
                                                    <p class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">36 Properties</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="assets/images/cities/cities2.png" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="Sun Francisco">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Sun Francisco</span>
                                                    <p class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">18 Properties</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="assets/images/cities/cities3.png" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="Washington D.C.">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Washington D.C.</span>
                                                    <p class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">27 Properties</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="assets/images/cities/cities4.png" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="New York">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">New York</span>
                                                    <p class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">56 Properties</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="assets/images/cities/cities2.png" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="Francisco">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">Francisco</span>
                                                    <p class="font-light text-tiny capitalize text-secondary group-hover:text-primary transition-all">18 Properties Sun</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
        ...
        <section class="testimonial-section pt-[50px] bg-no-repeat bg-white relative z-10" style="background-image: url(assets/images/testimonial/pattern.png);">
            <div class="container testimonial-carousel-one">
                                ...
                                <div class="swiper-slide">
                                    <div class="relative text-right">
                                        ...
                                        <div class="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                                            <img src="assets/images/testimonial/person1.png" class="w-auto h-auto block mx-auto relative z-[2]" loading="lazy" width="300" height="380" alt="Oliver Stephen">
                                            <img class="absolute right-[20px] bottom-0 z-[1]" src="assets/images/testimonial/shape.png" width="130" height="132" loading="lazy" alt="shape">
                                        </div>
                ...
                <path d="M1.925 19.2505H7.7L11.55 11.5505V0.000488281H0V11.5505H5.775L1.925 19.2505ZM17.325 19.2505H23.1L26.95 11.5505V0.000488281H15.4V11.5505H21.175L17.325 19.2505Z" fill="#0000"/>
                </svg>
            </span>
                                            <p class="text-primary">Bary do a great job to find the perfect home. It’s
                                                very easy for every one to buy, sell or rent property
                                                we belive they continure their great service.</p>
                                            <ul>
                                                <li class="flex flex-wrap items-center justify-between mt-4">
                                                    <span class="font-recoleta text-[18px] leading-none capitalize text-secondary">Oliver Stephen</span>
                                                    <span class="flex flex-wrap">
                         <span class="ml-[4px]">
                        <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.64181 4.13829L6.66642 3.70586L5.33634 1.00938C5.30001 0.935551 5.24024 0.875786 5.16642 0.839457C4.98126 0.748051 4.75626 0.824223 4.66368 1.00938L3.3336 3.70586L0.358214 4.13829C0.276182 4.15 0.201182 4.18868 0.143761 4.24727C0.0743407 4.31862 0.0360871 4.41461 0.0374056 4.51416C0.038724 4.6137 0.0795065 4.70864 0.150792 4.77813L2.30353 6.87696L1.79493 9.84063C1.78301 9.90957 1.79063 9.98048 1.81695 10.0453C1.84327 10.1101 1.88723 10.1663 1.94384 10.2074C2.00045 10.2485 2.06745 10.2729 2.13724 10.2779C2.20702 10.2829 2.27681 10.2682 2.33868 10.2356L5.00001 8.83633L7.66134 10.2356C7.73399 10.2742 7.81837 10.2871 7.89923 10.2731C8.10314 10.2379 8.24024 10.0445 8.20509 9.84063L7.69649 6.87696L9.84923 4.77813C9.90782 4.72071 9.94649 4.64571 9.95821 4.56368C9.98985 4.3586 9.84688 4.16875 9.64181 4.13829Z" fill="red"/>
                    </svg>
                            </span>
                                                    <span class="ml-[4px]">
                        <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M9.64181 4.13829L6.66642 3.70586L5.33634 1.00938C5.30001 0.935551 5.24024 0.875786 5.16642 0.839457C4.98126 0.748051 4.75626 0.824223 4.66368 1.00938L3.3336 3.70586L0.358214 4.13829C0.276182 4.15 0.201182 4.18868 0.143761 4.24727C0.0743407 4.31862 0.0360871 4.41461 0.0374056 4.51416C0.038724 4.6137 0.0795065 4.70864 0.150792 4.77813L2.30353 6.87696L1.79493 9.84063C1.78301 9.90957 1.79063 9.98048 1.81695 10.0453C1.84327 10.1101 1.88723 10.1663 1.94384 10.2074C2.00045 10.2485 2.06745 10.2729 2.13724 10.2779C2.20702 10.2829 2.27681 10.2682 2.33868 10.2356L5.00001 8.83633L7.66134 10.2356C7.73399 10.2742 7.81837 10.2871 7.89923 10.2731C8.10314 10.2379 8.24024 10.0445 8.20509 9.84063L7.69649 6.87696L9.84923 4.77813C9.90782 4.72071 9.94649 4.64571 9.95821 4.56368C9.98985 4.3586 9.84688 4.16875 9.64181 4.13829Z" fill="red"/>
                                ...
                                <div class="swiper-slide">
                                    <div class="relative text-right">
                                        <!-- shape and images -->
                                        <div class="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                                            <img src="assets/images/testimonial/person3.png" class="w-auto h-auto block mx-auto relative z-[2]" loading="lazy" width="300" height="380" alt="Sun Francisco">
                                            <img class="absolute right-[20px] bottom-0 z-[1]" src="assets/images/testimonial/shape.png" width="130" height="132" loading="lazy" alt="shape">
                                        </div>
                ...
                <path d="M1.925 19.2505H7.7L11.55 11.5505V0.000488281H0V11.5505H5.775L1.925 19.2505ZM17.325 19.2505H23.1L26.95 11.5505V0.000488281H15.4V11.5505H21.175L17.325 19.2505Z" fill="#0000"/>
                                            ...
                                            <ul>
                                                <li class="flex flex-wrap items-center justify-between mt-4">
                                                    <span class="font-recoleta text-[18px] leading-none capitalize text-secondary">Sun Francisco</span>
                                                    <span class="flex flex-wrap">
                         <span class="ml-[4px]">
                        <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="assets/images/team/person1.png" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Albert S. Smith">
                            </a>
                        </div>
                        ...
                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-recoleta font-normal text-base text-primary group-hover:text-white">Albert S. Smith</a></h3>
                            <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-white">Real Estate Agent</p>
                            <ul class="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-300 delay-300 first:ml-0 ml-[15px]"><a href="#" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                ...
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-500 delay-300 ml-[15px]"><a href="#" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                ...
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-700 delay-300 ml-[15px]"><a href="#" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="assets/images/team/person2.png" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Amelia Margaret">
                            </a>
                        </div>

                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-recoleta font-normal text-base text-primary group-hover:text-white">Amelia Margaret</a></h3>
                            <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-white">Real Estate Broker</p>
                            <ul class="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-300 delay-300 first:ml-0 ml-[15px]"><a href="#" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                        <svg width="7" height="12" viewBox="0 0 7 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4.36 4.20156V3.12156C4.36 2.65356 4.468 2.40156 5.224 2.40156H6.16V0.601562H4.72C2.92 0.601562 2.2 1.78956 2.2 3.12156V4.20156H0.760002V6.00156H2.2V11.4016H4.36V6.00156H5.944L6.16 4.20156H4.36Z" fill="currentColor" />
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="assets/images/team/person3.png" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Stephen Kelvin">
                            </a>
                        </div>

                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-recoleta font-normal text-base text-primary group-hover:text-white">Stephen Kelvin</a></h3>
                            <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-white">Real Estate Agent</p>
                            <ul class="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-300 delay-300 first:ml-0 ml-[15px]"><a href="#" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                        <svg width="7" height="12" viewBox="0 0 7 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="assets/images/team/person4.png" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt=" Michael Richard">
                            </a>
                        </div>

                        <div class="bg-[#FFFDFC] z-[1] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] rounded-[0px_0px_6px_6px] px-[15px] py-[20px] border-b-[6px] border-primary before:transition-all before:duration-300 group-hover:border-secondary relative before:absolute before:left-0 before:bottom-0 before:h-0 before:w-full before:bg-primary before:z-[-1] group-hover:before:h-full">
                            <h3><a href="agent-details.html" class="font-recoleta font-normal text-base text-primary group-hover:text-white"> Michael Richard</a></h3>
                            <p class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-white">Real Estate Broker</p>
                            <ul class="inline-flex items-center justify-center absolute w-full top-[-15px] left-0 overflow-hidden">
                                <li class="translate-y-[30px] group-hover:translate-y-[0] transition ease-in-out duration-300 delay-300 first:ml-0 ml-[15px]"><a href="#" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                                        <svg width="7" height="12" viewBox="0 0 7 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <form action="/search-lodge">
            <select multiple name="form[]" id="">
