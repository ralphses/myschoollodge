        ...
        <section class="popular-properties py-[80px] lg:py-[120px]">
            ...
            Sale</span>
                                        ...
                                        <div class="py-[20px] px-[20px] text-left">
                                            ...
                                            <ul>
                                                <li class="flex flex-wrap items-center justify-between">
                                                    <span class="font-recoleta text-base text-primary leading-none">Price: $255300</span>

                                                    <span class="flex flex-wrap items-center">
                    <button class="mr-[15px] text-[#494949] hover:text-secondary">
                    ...
                    <button class="text-[#494949] hover:text-secondary">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            Co-living</span>
                                        ...
                                        <div class="py-[20px] px-[20px] text-left">
                                            ...
                                            <ul>
                                                <li class="flex flex-wrap items-center justify-between">
                                                    <span class="font-recoleta text-base text-primary leading-none">Price:  $1553/m</span>
                            ...
                            <defs>
                                <clipPath class="clip0_656_640">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                        <div class="relative">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties8.jpg" class="w-full h-full" loading="lazy" width="370" height="266" alt="De Parasiya Appartment.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
            ...
            Sale</span>
                    ...
                    <button class="text-[#494949] hover:text-secondary">
                        ...
                        <div id="list" class="grid-tab-content">
                            <div class="col-span-12">
                                <div class="grid grid-cols-1 gap-[30px]">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties4.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="Elite Garden Resedence.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            ...
                                            <spanclass="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-secondary leading-none text-[14px] font-normal">for Sale</span>
                                        </div>
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties5.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="De Parasiya Appartment.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                            ...
                                            <span
            class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-secondary leading-none text-[14px] font-normal">for
            Co-living</span>
                                        </div>
                            ...
                            <defs>
                                <clipPath class="clip0_656_640">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties6.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="Duplex de Villa">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                            ...
                            <defs>
                                <clipPath class="clip0_656_640">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties7.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                            ...
                            <defs>
                                <clipPath class="clip0_656_640">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties3.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="Ruposibangla de parlosia.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                            ...
                            <defs>
                                <clipPath class="clip0_656_640">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties3.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="Sinomen Studio Palace.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                            ...
                            <defs>
                                <clipPath class="clip0_656_640">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties7.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="Elite Garden Resedence.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                            ...
                            <defs>
                                <clipPath class="clip0_656_640">
                                    ...
                                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] flex flex-wrap flex-col md:flex-row items-center py-[25px] px-[25px]">
                                        <div class="relative mb-[15px] lg:mb-[0px] lg:mr-[30px] block w-full lg:max-w-[270px]">
                                            <a href="/properties-details" class="block">
                                                <img src="assets/images/properties/properties8.jpg" class="w-full h-full rounded-[6px]" loading="lazy" width="370" height="266" alt="De Parasiya Appartment.">
                                            </a>
                                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="assets/images/icon/camera.png" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                                <button class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="assets/images/icon/video.png" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                                            </div>
                                            <span class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-secondary leading-none text-[14px] font-normal">for Sale</span>
                                        </div>
